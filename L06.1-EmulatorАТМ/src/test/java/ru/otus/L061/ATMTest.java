...
public class ATMTest {
    ...
    public void loadMoney() {
        atm.loadMoney(Denomination.FiveThousand, 5);
        Assert.assertEquals(25000, atm.infoBalance());

        atm.loadMoney(Denomination.FiveHundred, 1);
    ...
    public void giveMoney() throws InsufficientFundsException, InvalidAmountException {
        atm.loadMoney(Denomination.FiveThousand, 5);
        atm.loadMoney(Denomination.FiveHundred, 1);
        atm.loadMoney(Denomination.FiveHundred, 10);
        atm.loadMoney(Denomination.TwoHundred, 10);
